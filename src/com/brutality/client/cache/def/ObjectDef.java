...
public final class ObjectDef {
	...
	public static ObjectDef forID(int i) {
		...
		if(i == 29150) {
			...
			objectDef.actions[0] = "Switch-normal";
			objectDef.actions[1] = "Switch-ancient";
			objectDef.actions[2] = "Switch-lunar";
			objectDef.name = "Magical altar";
		}
		
		switch (i) {
		case 11338://bank booth
			objectDef.actions[2] = "Use-quickly";
			break;
		case 411:
			objectDef.name = "@cya@Altar";
			objectDef.actions[0] = "Restore @gre@Healt";
			objectDef.actions[1] = "Restore @gre@Special Attack";
			break;
		case 6552:
