package com.brutality.client.entity.model;
import java.util.ArrayList;

import com.brutality.client.Configuration;
import com.brutality.client.Stream;
import com.brutality.client.cache.anim.Class18;
...
import com.brutality.client.net.OnDemandFetcherParent;
...
public class Model extends Animable {
            ...
            if(textureIds != null) {
                ...
                for(int i = 0; i < totalModelColors; i++) {
                    if(textureIds[i] == -1 && anIntArray1637[i] == 2) {
                    	currentModelColors[i] = 65535;
                        anIntArray1637[i] = 0;
                    }
                    if(textureIds[i] >= max && textureIds[i] != 1227 || textureIds[i] < 0 || textureIds[i] == 39) {
                        anIntArray1637[i] = 0;
                        continue;
                    }
                    ...
                    currentModelColors[i] = textureIds[i];
        ...
        public void method470(int frame, int nextFrame, int end, int cycle) {
                ...
                Class18 list1 = currentAnimation.skin;
                anInt1681 = 0;
                anInt1682 = 0;
                anInt1683 = 0;
            ...
            if (nextFrame != -1) {
                        ...
                        if (nextAnimation.skin != list1)
                                nextAnimation = null;
                        list2 = nextAnimation.skin;
            }
