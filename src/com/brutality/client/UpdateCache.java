...
public class UpdateCache implements Runnable {
	...
	public static final String ZIP_URL = "http://anxiouspk.net/Cache/Roat.Cache.zip";
	public static final String VERSION_URL = "http://anxiouspk.net/Cache/cacheVersion.txt";
