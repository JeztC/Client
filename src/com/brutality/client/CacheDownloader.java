...
public class CacheDownloader {
    ...
    private String cacheLink = "http://anxiouspk.net/Cache/Roat.Cache.zip";
    ...
    private void downloadFile(String adress, String localFileName) {
            ...
            try {
                    ...
                    while((numRead = in.read(data)) != -1) {
                            ...
                            drawLoadingText(percentage, "MonsterPk is currently - Downloading Cache [" + percentage + "%]");

                    }

                    System.out.println(localFileName + "\t" + numWritten);
                    drawLoadingText("MonsterPk - Unzipping...");
